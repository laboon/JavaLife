...
public class WorldTest {
    /* In a lot of these tests, we differentiate between large and small rows;
     * this I considered an edge case because of the modular arithmetic involved
     * (numbers wrap back around to zero) */
